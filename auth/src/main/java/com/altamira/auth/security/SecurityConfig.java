package com.altamira.auth.security;

import com.altamira.common.exceptions.auth.CustomAccessDeniedHandler;
import com.altamira.common.exceptions.auth.CustomUnauthorizedHandler;
import com.altamira.auth.security.jwt.JwtTokenFilter;
...
public class SecurityConfig {
	...
	private final String[] WHITE_LIST_URL = {"/api/v1/auth/login",
			...
			"/api/v1/auth/refresh", "/api/v1/users/register-owner", "/api/v1/notifications/**"};
