package com.altamira.auth.controller;

import com.altamira.auth.dto.LoginRequest;
import com.altamira.auth.dto.AuthResponse;
import com.altamira.auth.security.jwt.JwtUtils;
...
public class AuthController {
	...
	public ResponseEntity<AuthResponse> authenticateUser(@Valid @RequestBody LoginRequest loginRequest) {
		...
		String role = userDetails.getAuthorities().stream()
				...
				.findFirst()
				.orElseThrow(()-> new RuntimeException("NO ROLE ERROR"));
